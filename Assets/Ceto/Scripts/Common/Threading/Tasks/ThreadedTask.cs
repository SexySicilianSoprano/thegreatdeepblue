...
namespace Ceto.Common.Threading.Tasks
{
    ...
    /// </summary>
	public abstract class ThreadedTask : IThreadedTask
	{
		...
		protected volatile bool m_done;
		...
		protected volatile bool m_noFinish;
		...
		protected volatile bool m_runOnStopWaiting;
		...
		protected volatile bool m_cancelled;

		/// <summary>
		/// The scheduler used to run this task
		/// </summary>
        public ITaskScheduler Scheduler { set { m_scheduler = value; } }
		...
		{
			return string.Format("[Task: isThreaded={0}, done={1}, started={2}, cancelled={3}]", m_isThreaded, m_done, m_started, m_cancelled);
		}

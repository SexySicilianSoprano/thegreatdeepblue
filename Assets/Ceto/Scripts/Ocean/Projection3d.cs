...
namespace Ceto
{
	...
	public class Projection3d : IProjection 
	{
		...
		/// </summary>
		double[] MATRIX_BUFFER0, MATRIX_BUFFER1;
		...
		/// </summary>
		public void UpdateProjection(Camera cam, bool projectSceneView)
		{
			...
			SetRow(0, m_projectorI, HProject(m_projectorIVP, m_quad[0]));
			SetRow(1, m_projectorI, HProject(m_projectorIVP, m_quad[1]));
			SetRow(2, m_projectorI, HProject(m_projectorIVP, m_quad[2]));
			SetRow(3, m_projectorI, HProject(m_projectorIVP, m_quad[3]));
		...
		void AimProjector(Camera cam)
		{
			...
			double maxHeight = Math.Max(50.0, Ocean.MAX_WAVE_HEIGHT + 10.0);
		...
		/// </summary>
		double[] HProject(double[] ivp, double[] corner)
		{

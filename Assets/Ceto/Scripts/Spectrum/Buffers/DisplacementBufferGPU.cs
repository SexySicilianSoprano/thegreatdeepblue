...
namespace Ceto
{
	...
	public class DisplacementBufferGPU : WaveSpectrumBufferGPU, IDisplacementBuffer
	{
		...
		public DisplacementBufferGPU(int size, Shader initSdr, Shader fourierSdr)
			: base(size, initSdr, fourierSdr, NUM_BUFFERS)
		{
		...
		public Vector4 MaxRange(Vector4 choppyness, Vector2 gridScale)
		{
			...
			return QueryDisplacements.MaxRange(m_displacements, choppyness, gridScale);

...
namespace Ceto
{
	...
	[AddComponentMenu("Ceto/PostEffects/UnderWaterPostEffect")]
	...
	public class UnderWaterPostEffect : MonoBehaviour 
	{
       ...
       ///  So underwater fog goes dark at night.
		...
		void OnRenderImage (RenderTexture source, RenderTexture destination)
		{
            ...
            if (underWaterPostEffectSdr == null || m_material == null) 
			{
            ...
            //If rendering mode deferred then toggling the depth
            //mode cause some strange issue with underwater effect
            //if using the opaque oceaqn materials.
            //Maybe fixed in Unity versions above 5.1.3

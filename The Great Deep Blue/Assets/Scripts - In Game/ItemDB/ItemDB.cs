...
public static class ItemDB {
    ...
    public static Item Scout = new Item
    {
       ...
       // MultiPlayerPrefab = Resources.Load("Models/Units/SteamHouse/Scout/ScoutMultiplayer", typeof(GameObject)) as GameObject,
    ...
    public static Item Destroyer = new Item
    {
       ...
       // MultiPlayerPrefab = Resources.Load("Models/Units/SteamHouse/Destroyer/DestroyerMultiplayer", typeof(GameObject)) as GameObject,
    ...
    public static Item FloatingFortress = new Item
	{
      ...
      //  MultiPlayerPrefab = Resources.Load("Models/Buildings/SteamHouse/Floating Fortress/FloatingFortressMultiplayer2", typeof(GameObject)) as GameObject,
        SortOrder = 100,
	...
	public static Item NavalYard = new Item
	{
      ...
      //  MultiPlayerPrefab = Resources.Load("Models/Buildings/SteamHouse/Naval Yard/NavalYardMultiplayer", typeof(GameObject)) as GameObject,
    ...
    public static Item Refinery = new Item
    {
       ...
       // MultiPlayerPrefab = Resources.Load("Models/Buildings/SteamHouse/Refinery/RefineryMultiplayer", typeof(GameObject)) as GameObject,
    ...
    public static Item Laboratory = new Item
    {
      ...
      //  MultiPlayerPrefab = Resources.Load("Models/Buildings/SteamHouse/Laboratory/LaboratoryMultiplayer", typeof(GameObject)) as GameObject,
